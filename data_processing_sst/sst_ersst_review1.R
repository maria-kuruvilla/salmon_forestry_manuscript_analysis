...
sst_download(years = 1955:1995, months = 3:7, save.dir = here("data_processing_sst", "sst_ersst"),
                          version = 5)

sst <- sst_load(years$sst_year, 3:7, here("data_processing_sst", "sst_ersst", "sst_ersst"), version = 5)
...
write.csv(sst_df, here("data_processing_sst", "data", "sst_ersst_df_sep2026.csv"), row.names = FALSE)
